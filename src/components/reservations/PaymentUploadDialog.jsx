...
export function PaymentUploadDialog({ open, onOpenChange, reservation }) {
    const { user } = useAuth();
    ...
    const handleUploadAndPay = async () => {
        ...
        try {
            ...
            await createPaymentMutation.mutateAsync({
                ...
                payment_method: "manual_transfer", // Or other method if selectable
                proof_url: publicUrl,
            });
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Sube tu comprobante de pago para validar tu reservación.
                    </DialogDescription>
                </DialogHeader>
