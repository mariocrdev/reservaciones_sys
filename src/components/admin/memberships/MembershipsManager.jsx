    ...
    <div className="space-y-4 pt-4">
      ...
      {plans?.length === 0 ? (
        <p className="text-sm text-muted-foreground italic">
          No hay planes configurados para este producto.
        </p>
      ) : (
                ...
                <div className="flex justify-between items-start">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          handleToggleProductActive(product, !product.active)
                        }
                      >
        ...
        {products?.length === 0 && (
          <div className="text-center py-12 border rounded-lg bg-muted/10">
            <h3 className="text-lg font-medium">
              No hay productos de membresía
            </h3>
            <p className="text-muted-foreground mt-1">
              Crea uno nuevo para empezar a vender suscripciones.
            </p>
          </div>
        )}
      </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción eliminará el producto "{productToDelete?.name}" y
              TODOS sus planes asociados.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancelar</AlertDialogCancel>
